...
4.  Practice questions
    ...
    -   Fixation day 1 (Optional)

    -   Pre-day 2 (Recomended)
...
-   Likelihood is about explaining the data you already have[^02-linear-models-4].

-   No more a line of best fit, but an expectation!

[^02-linear-models-4]: Finding the parameter values under which the observed data are most plausible according to the assumed data-generating process.
...
Here we can construct confidence intervals by approximating the standard errors using delta method[^02-linear-models-5].

[^02-linear-models-5]: The Delta Method approximates the uncertainty of a transformed estimator (derived quantity), assuming it was originally approximately normal.
