...
$\mathbf{y}$ is a random variable[^04-bayesian-non-linear-models-1] that arises from a distribution.

[^04-bayesian-non-linear-models-1]: By definition, a random variable assigns a numerical value to the outcome of a random experiment.
...
How the predictions (expected value) looks like with 95% Posterior Predictive Interval[^04-bayesian-non-linear-models-2]:

[^04-bayesian-non-linear-models-2]: Intervals:
