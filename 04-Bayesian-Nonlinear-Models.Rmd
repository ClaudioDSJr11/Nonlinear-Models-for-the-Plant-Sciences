...
-   Day 1
    ...
    -   When they are similar (normal errors).
...
<center>Different techniques can help with model selection, however, for mechanistic models that have deep biological meaning, this criteria should be the first to be considered.</center>
:::
